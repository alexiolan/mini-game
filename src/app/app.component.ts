...
export class AppComponent implements OnInit {
  ...
  private createGift() {
    ...
    const e = {
      image: this.images['assets/gift_' + this.randomInt(1, 4) + '.png'],
      x: x,
      y: -h,
      r: 0,
      w: w,
  ...
  private createBubble() {
    ...
    const e = {
      image: this.images['assets/bubble.png'],
      x: x,
      startX: x,
      y: -h,
      r: 0,
  ...
  private gameDraw() {
    ...
    this.ctx.drawImage(this.images['assets/bg.png'], 0, 0, this.canvas.width, this.canvas.height);
  ...
  private drawPlayer() {
    this.ctx.drawImage(this.images['assets/player.png'], this.player.x - this.player.w / 2, this.player.y, this.player.w, this.player.h);
  }
  ...
  private drawLives() {
    ...
    const imgSize = 24;
    const mrg = 8;
    const heart = this.images['assets/heart.png'];
    const heartBg = this.images['assets/heart_bg.png'];
    let img = heart;
  ...
  private drawProgress() {
    const prBg = this.images['assets/progress_bar_bg.png'];
    const pr = this.images['assets/progress_bar.png'];
    const oy = 16;
    ...
    this.ctx.drawImage(this.images['assets/gift_icon.png'], sPos + pbgW + 16, oy, ph, ph);
  }
}
